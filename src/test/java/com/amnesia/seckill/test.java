...
public class test {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig
                .Builder("jdbc:mysql://localhost:3306/seckill?serverTimezone=UTC&useSSL=true&useUnicode=true&characterEncoding=UTF-8",
                "root",
                "123456")
                .dbQuery(mySqlQuery).
                        build();
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("pojo")//实体类包名
                .parent("com.amnesia.seckill")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
